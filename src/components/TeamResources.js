...
function TeamResources() {
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto space-y-12">
      ...
      {/* Featured: Team Overview */}
      <section className="bg-gradient-to-br from-primary via-primary to-slate-800 rounded-2xl p-8 text-white relative overflow-hidden shadow-xl shadow-primary/20 cursor-pointer group"
      ...
      >
        <div className="relative z-10">
          <div className="flex items-start justify-between mb-6">
            <div className="flex-1">
              ...
              <p className="text-slate-200 text-sm mb-4 max-w-2xl">
                Explore your team structure, understand roles and responsibilities, and connect with your colleagues. Get to know the people you'll be working with every day.
              </p>
              <div className="flex items-center gap-4 flex-wrap">
                <div className="flex items-center gap-2">
                  <span className="material-symbols-outlined text-sm">people</span>
                  <span className="text-xs text-slate-200">Team Hierarchy</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="material-symbols-outlined text-sm">flag</span>
                  <span className="text-xs text-slate-200">Mission & Values</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="material-symbols-outlined text-sm">check_circle</span>
                  <span className="text-xs text-slate-200">Key Responsibilities</span>
                </div>
              </div>
            </div>
            <button className="px-6 py-3 bg-white text-primary font-bold rounded-lg hover:bg-slate-100 transition-all flex items-center gap-2 group-hover:scale-105 shrink-0">
              <span>View Team</span>
        ...
        <span className="material-symbols-outlined absolute -right-8 -bottom-8 text-[180px] text-white/5 rotate-12 select-none">groups</span>
      </section>
      ...
      <section>
        ...
        <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden">
          <div className="divide-y divide-slate-100 dark:divide-slate-800">
            ...
            <div className="p-4 flex items-center justify-between hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
              <div className="flex items-center gap-4">
                <div className="size-12 rounded bg-blue-500 flex items-center justify-center text-white shrink-0">
                  <svg className="w-8 h-8 fill-current" viewBox="0 0 24 24">
                    <path d="M11.571 11.513H0a5.218 5.218 0 0 0 5.218 5.215h2.353v-5.215zm11.04 0H12.36a5.215 5.215 0 1 0 10.431 0zM5.218 0A5.215 5.215 0 0 0 0 5.218a5.215 5.215 0 0 0 5.218 5.215h11.13A5.215 5.215 0 1 0 16.348 0z" />
                  </svg>
                </div>
                <div>
                  <h5 className="text-sm font-bold text-slate-900 dark:text-white">Jira</h5>
                  <p className="text-xs text-slate-500">Project management and issue tracking</p>
                </div>
              </div>
              <div className="flex items-center gap-8">
                <div className="flex flex-col items-end">
